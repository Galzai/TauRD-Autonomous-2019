 ...
 */
uint8_t visual_cone_filter(map_t *pGloal_map, map_t* pLocal_map, coordinates_t *pCur_coordinates);
 ...
 * @return SUCCESSS if filtering performed correctly
 */
uint8_t kinamatic_cone_filter(map_t *pGloal_map, map_t* pLocal_map, coordinates_t *pCur_coordinates);
